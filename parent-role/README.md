...
| `hooks/require-spawn-task-title.sh` | PreToolUse `mcp__ccd_session__spawn_task` | 親の `spawn_task` の title を task-split §1 の命名規約 4 形で検査し、当たらなければ deny (別案件の新しい親だけは番号照合を飛ばす) |
